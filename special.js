...
const pages = [
    ...
    `The story goes 8 years back now...,\nIndeed a long time, eh?`,
    `I don't know how god put that,\nkind of strength in me(in 8th std.) to ask you out that day,`,
    ...
    `After 8th std, we became closest of friends, sharing everything,\n laughing together on Somanka and pradeep Sir, if you remember😂....`,
    `And then, again I proposed you in 9th Std, \nif you remember, and if u don't, \nI had a slip of tongue saying that on PTM😝,`,
    ...
    `Anyways, the conditions were, \"We\'re to young for this and blah....blah...blah...`,
    ...
    `French class mein bahot bakchodi bhi kari, and bahottt kuchhh...`,
    `Then straight after 10th std, on a random day, you called me in the evening, and said \"YESSS!\"`,
    `That was like the most happiest moment of my life, I was on cloud nine, and I still am, knowing that you said yes to me`,
    `Yyyyyyrrrrrr VNnnnn!....Mai vo date bhi bhul gya😅,\ntujhe yaad hai? Around April or May , plss yaad ho toh bataiyo😅`,
    `Aur fir iss part ke baad thoda guilt aajata hai, kyuki maine bahhhooooottttttt badi galti kardi thi😭`,
    `I am reallllyyyyyyy Soooooorrrrrrrrrryyyyyyyyyy for that Raja, I know I hurted you deeply`,
    ...
    `Ha bhale hi phone dhange se use nhi karti, but jaisi bhi hai, perfect hai!`,
